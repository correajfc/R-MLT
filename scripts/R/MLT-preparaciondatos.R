...
# %>% View()
  ...
  write_csv(MLTExpos1956_2016,"output_data/MLTexpos1956-2016.csv")
...
#   write_csv(grafoMLTcur_art_art_1956_2016,"output_data/grafoMLTcur_art_art_1956_2016.csv")
# 
# grafoMLTcur_art_1956_2016<-full_join(MLT_expos,expo_curador_artista,by="id_expo")
#   write_csv(grafoMLTcur_art_1956_2016,"output_data/grafoMLTcur_art_1956_2016.csv")
#   
# grafoMLTar_art_1956_2016<-full_join(MLT_expos,expo_artista_artista,by="id_expo")
#   write_csv(grafoMLTar_art_1956_2016,"output_data/grafoMLTart_art_1956_2016.csv")  
#   
...
# #guardar en archivos
#   write_csv(agente_agente_relacion,"output_data/grafoMLTsimplificado_agente_agente_1956_2016.csv")
#     write_csv(artistas_artistas_acumulado ,"output_data/grafoMLTsimplificado_art_art_1956_2016.csv")
#         write_csv(curador_artistas_acumulado ,"output_data/grafoMLTsimplificado_cur_art_1956_2016.csv")
# 
# 
#   
# ###### Ver histogramas 
